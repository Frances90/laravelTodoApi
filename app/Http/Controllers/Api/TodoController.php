            ...
            new OA\Response(
                ...
                items: new OA\Items(
                    ...
                    properties: [
                        ...
                        new OA\Property(property: 'titel', type: 'string', example: 'Wäsche waschen'),
                        new OA\Property(property: 'erledigt', type: 'boolean', example: false),
                        new OA\Property(property: 'faellig_am', type: 'string', format: 'date', example: '2025-05-01'),
                        new OA\Property(property: 'erstellt_am', type: 'string', format: 'date-time', example: '2025-04-01T10:00:00Z')
                    ]
                )
                )
            )
